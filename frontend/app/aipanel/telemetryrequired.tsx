            ...
            <div className="flex items-center justify-center p-8 text-center">
                <div className="max-w-md space-y-6">
                    <div className="space-y-4">
                        ...
                        <h2 className="text-2xl font-semibold text-foreground">CTMWave AI</h2>
                        <p className="text-secondary leading-relaxed">
                            CTMWave AI is free to use and provides integrated AI chat that can interact with your widgets,
                    ...
                    <div className="bg-blue-900/20 border border-blue-500 rounded-lg p-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="text-left">
                                <div className="text-blue-400 font-medium mb-1">Telemetry keeps CTMWave AI free</div>
                                <div className="text-secondary text-sm mb-3">
                                    <p className="mb-2">
                                        To keep CTMWave AI free for everyone, we require a small amount of <i>anonymous</i>{" "}
                                    ...
                                    <p className="mb-2">
                                        ...
                                        identifying information. CTMWave AI is powered by OpenAI's APIs, please refer to
