    ...
    return (
        <div className="flex flex-col h-full">
            <header className="flex items-center gap-4 mb-6 w-full unselectable flex-shrink-0">
                ...
                <div className="text-[25px] font-normal text-foreground">CTMWave AI</div>
            </header>
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-8 pr-6 unselectable">
                    <div className="flex flex-col items-start gap-6 max-w-md">
                        ...
                        <div className="flex flex-col items-start gap-4 text-secondary">
                            <p>
                                CTMWave AI is your terminal assistant with context. I can read your terminal output,
                            ...
                            <div className="flex items-start gap-3 w-full">
                                ...
                                <p>
                                    Toggle the CTMWave AI panel with the{" "}
            ...
            <div className="flex-1 flex flex-row gap-0 min-h-0">
                <div className="flex-1 flex flex-col items-center justify-center gap-8 pr-6 unselectable">
                    <div className="flex flex-col items-start gap-6 max-w-md">
                        <div className="flex flex-col items-start gap-4 text-secondary">
                            <p>
                                CTMWave Terminal can preview markdown, images, and video files on both local{" "}
                                <i>and remote</i> machines.
                            </p>
                            ...
                            <div className="flex items-start gap-3 w-full">
                                ...
                                <div>
                                    <p className="mb-2">
                                        ...
                                        to preview files in CTMWave Terminal's graphical viewer
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3 w-full">
                                ...
                                <div>
                                    <p className="mb-2">
                                        ...
                                        to open config files or code files in CTMWave Terminal's graphical editor
                                    </p>
                                </div>
                            </div>
