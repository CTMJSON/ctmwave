...
const chatConfigs: ChatConfig[] = [
    {
        userPrompt: "Check out ~/ctmwave and summarize the project — what it does and how it's organized.",
        toolName: "read_dir",
        toolDescription: 'reading directory "~/ctmwave"',
        markdownResponse: `Here's a quick, file-structure–driven overview of this repo (CTMWave Terminal):
...
grep -Ei 'error|panic|fatal|websocket|1006|1011' \\
  "$HOME/Library/Application Support/ctmwave-dev/waveapp.log" | tail -n 200

# 2) Inspect around the disconnect window
awk '($0 ~ /2025-10-10 18:08:2[0-9]/){print}' \\
  "$HOME/Library/Application Support/ctmwave-dev/waveapp.log"

# 3) Live follow for recurring drops
tail -f "$HOME/Library/Application Support/ctmwave-dev/waveapp.log" \\
