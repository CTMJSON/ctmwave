    ...
    return (
        <div className="flex flex-col h-full">
            <header className="flex flex-col gap-2 border-b-0 p-0 mt-1 mb-4 w-full unselectable flex-shrink-0">
                ...
                <div className="text-center text-[25px] font-normal text-foreground">Welcome to CTMWave v0.14!</div>
            </header>
            ...
            >
                <div className="flex flex-col items-center gap-3 w-full mb-2 unselectable">
                    <div className="flex flex-col items-center gap-4">
                        <div className="flex flex-row gap-4 items-center">
                            <div className="flex h-[52px] px-3 items-center rounded-lg bg-hover text-accent text-[24px]">
                                ...
                                <span className="font-bold ml-2 font-mono">CTMWave AI</span>
                            </div>
                        ...
                        <div className="text-secondary leading-relaxed max-w-[600px] text-left">
                            <p className="mb-4">
                                CTMWave AI is your terminal assistant with full context. It can read your terminal output,
                                analyze widgets, read and write files, and help you solve problems&nbsp;faster.
                            </p>
                            <p className="mb-4">
                                <span className="font-semibold text-foreground">New in v0.13:</span> CTMWave AI now
                    ...
                    <div className="flex flex-col items-center gap-3 text-center max-w-[550px]">
                        <div className="text-foreground text-base">Thanks for being an early CTMWave adopter! ⭐</div>
                        <div className="text-secondary text-sm text-left">
                            A GitHub star shows your support for CTMWave Terminal (and open-source) and helps us reach more
                            developers.
                        </div>
                    </div>
                </div>
...
const UpgradeOnboardingMinor = () => {
    ...
    const handleStarClick = async () => {
        ...
        window.open("https://github.com/CTMJSON/ctmwave?ref=upgrade", "_blank");
