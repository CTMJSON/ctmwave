...
document.title = `CTMWave Terminal`;
...
async function reinitWave() {
    console.log("Reinit CTMWave");
    getApi().sendLog("Reinit CTMWave");
    ...
    document.title = `CTMWave Terminal - ${initialTab.name}`; // TODO update with tab name change
...
async function initWave(initOpts: WaveInitOpts) {
    getApi().sendLog("Init CTMWave " + JSON.stringify(initOpts));
    ...
    console.log("CTMWave Init", globalInitOpts);
    ...
    console.log("CTMWave First Render");
    ...
    console.log("CTMWave First Render Done");
    getApi().setWindowInitStatus("wave-ready");
}
...
async function initBuilder(initOpts: BuilderInitOpts) {
    ...
    document.title = appIdToUse ? `CTMWave App Builder (${appIdToUse})` : "CTMWave App Builder";
