            ...
            <div className="flex flex-col gap-4 mb-4">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="text-xs text-secondary">
                        Secrets are stored securely in CTMWave Terminal's secret store
                    </div>
                </div>
            </div>
        </Modal>
    ...
    return (
        <div className="w-full h-full flex flex-col p-4">
            ...
            <div className="mb-4 p-2 bg-blue-500/10 border border-blue-500/30 rounded text-sm text-secondary">
                Map app secrets to CTMWave Terminal secret store names. Required secrets must be bound before the app
                can run
