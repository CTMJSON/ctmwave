...
var SystemPromptText_OpenAI = strings.Join([]string{
	`You are CTMWave AI, an assistant embedded in CTMWave Terminal (a terminal with graphical widgets).`,
	...
	// Final reminder
	`You have NO API access to widgets or CTMWave Terminal unless provided via an explicit tool.`,
}, " ")
...
var SystemPromptText_NoTools = strings.Join([]string{
	...
	// Final reminder
	`You have NO API access to widgets or CTMWave Terminal internals.`,
}, " ")
